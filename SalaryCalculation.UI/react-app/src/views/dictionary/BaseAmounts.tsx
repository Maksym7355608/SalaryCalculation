...
import {BaseAmount} from "../../models/dictionaries";
...
export default function BaseAmounts() {
    const [baseAmounts, setBaseAmounts] = useState<BaseAmount[]>([]);
    ...
    const handleSearch = (data: any) => {
        ...
        restClient.dictionary.searchBaseAmountsAsync(data).then(r => {
            setBaseAmounts(r);
        });
    };
